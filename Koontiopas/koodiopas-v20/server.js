...
app.post("/api/teacher/submissions/:id/review", requireTeacher, (req, res) => {
  ...
  if (assessment && Array.isArray(assessment.scores)) {
    ...
    item.assessment={scores,totalPoints,maxPoints,percent:maxPoints?Math.round(totalPoints/maxPoints*100):0};
  }
...
app.listen(PORT, () => {
  console.log(`Koodiopas v20: ${BASE_URL}`);
