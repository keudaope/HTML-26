  ...
  card.innerHTML = `
    <div class="between">
      ...
      <div class="courseRepoSettings">
        ...
        <small class="muted">Template voi sisältää kurssin yhteisiä tiedostoja tai valmiita tehtäväkansioita. Ilman templatea Koodiopas luo kurssirepon ja tehtäväkansiot itse.</small>
...
$("preview").onclick = async () => {
  ...
  $("previewInfo").textContent =
    ...
    (d.course.templateRepoUrl ? "kurssipohja käytössä" : "ei kurssipohjaa – tehtäväkansio luodaan Koodioppaasta");
