...
function statusLabel(status) {
  return status === "course_repo_created_and_assignment_published" ? "✅ kurssirepo + tehtävä luotu" :
    status === "course_repo_created_assignment_exists" ? "✅ kurssirepo luotu, tehtävä oli pohjassa" :
    status === "course_repo_created" ? "✅ kurssirepo luotu" :
    status === "assignment_published" ? "✅ tehtävä julkaistu" :
